...
async def edit_metadata(listener, base_dir: str, media_file: str, outfile: str, metadata: str = ''):
    cmd = [
        ...
        "-c:a", "copy",
        "-c:s", "copy",
        "-metadata", f"title=Join Our Telegram Channel @{metadata}",
        "-metadata:s:v", f"title=Join Our Telegram Channel @{metadata}",
        "-metadata:s:a", f"title=@{metadata}",
        "-metadata:s:s", f"title=@{metadata}",
        "-metadata", f"author=Telegram - @{metadata}",
        "-metadata", f"artist=Telegram - @{metadata}",
        "-metadata", f"website=Telegram Channel - https://t.me/{metadata}",
